...
$(document).ready(function(){
    ...
    $(".addcart").on('click', '.addcart', function(){
        var pid=$(this).val();
    ...
    alert('Product added to cart. You can customize this message or perform other actions.');
});
    
    $(".concart").on('click', '.concart', function(){
        var pid=$(this).val();
        var qty=$('#qty'+pid).val();
        $('#cart'+pid).hide();
        if (qty.match(/^\d+$/)){
    ...
    alert('Quantity updated. You can customize this message or perform other actions.');
