        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button style="background-color: #d9534f; color: #fff; border: none; padding: 5px 10px; margin: 3px;" data-toggle="modal" data-target="#delproduct_<?php echo $pid; ?>">Delete</button>
                    ...
                    <form role="form" method="POST" action="edit_product.php<?php echo '?id=' . $pid; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group input-group">
                            ...
                            <select style="width:400px;" class="form-control" name="supplier">
                                <?php
                                if (isset($b['supplierid']) && isset($b['supplier'])) {
                                    echo '<option value="' . $b['supplierid'] . '">' . $b['supplier'] . '</option>';
                                }
